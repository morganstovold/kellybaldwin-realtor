      ...
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            From modern family homes to charming Victorians, find your dream
            home in Solano County&apos;s most desirable neighborhoods.
          </p>
        </div>
          ...
          {featuredProperties.length > 0 ? (
            ...
            <div className="col-span-full text-center py-12">
              ...
              <p className="text-gray-500 mb-6">
                Featured properties will appear here once they are added to the
                database.
              </p>
              <Link
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
          ...
          <Link className={buttonVariants({ variant: "default" })} href="/contact">
            Contact Kelly
          </Link>
        </div>
      </div>
